...
public class Imballaggi extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_imballaggi);
        ...
        obj.setOnItemClickListener(new AdapterView.OnItemClickListener(){
            ...
            public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
                ...
                dataBundle.putInt("idimb", id_To_Search);

                Intent intent = new Intent(getApplicationContext(),DisplayImballaggi.class);
