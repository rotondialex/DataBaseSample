...
public class DisplayImballaggi extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_display_imballaggi);
        ...
        if(extras !=null) {
            ...
            int Value = extras.getInt("idimb");
            Button b = (Button)findViewById(R.id.button1);
            b.setText("Aggiungi");
            if(Value>0){
                //means this is the view part not the add contact part.
                Cursor rs = mydb.getImballaggio(Value);
                id_To_Update = Value;
                rs.moveToFirst();
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        if(extras !=null) {
            int Value = extras.getInt("idimb");
            if(Value>0){
                getMenuInflater().inflate(R.menu.display_imball, menu);
            } else{
