...
public class MprPercent extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mpr_percent);
        ...
        array_list = mydb.getAllMaterieprime();
...
// Ordino Alfabeticamente
        ...
        cerca.addTextChangedListener(new TextWatcher() {
            public void afterTextChanged(Editable s) {
                ...
                array_list = mydb.getAllMaterieprimeDaCerca(testo);
                array_ID = mydb.getAllMPIDdaCerca(testo);
                // Ordino Alfabeticamente
                String Supporto;
                Integer r,x,Supp;
                String [] Perordinare=array_list.toArray(new String[0]);
    ...
    public void RestituisciQuant(View view) {
            ...
            if (Integer.parseInt(idmpr.getText().toString()) > -1) {
                if (mydb.cegiaComp(idfrm,Integer.parseInt(idmpr.getText().toString()))) {
                    Toast.makeText(getApplicationContext(), "Componente già presente!",
                            Toast.LENGTH_SHORT).show();
                }else {
                    if (mydb.insertComponente(idfrm, Integer.parseInt(idmpr.getText().toString()), Double.parseDouble(Percent.getText().toString()))) {
                    ...
                    returnIntent.putExtra("qualeattivita","Aggiungi");
