...
import static com.example.banco.databasesample.R.id.editText;

public class MateriePrime extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_materie_prime);
        ...
        obj.setOnItemClickListener(new OnItemClickListener(){
            ...
            public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,long arg3) {
                ...
                dataBundle.putInt("idmp", id_To_Search);
